...
const modalContent = {
    ...
    tickets: {
        title: "TICKETS",
        text: "Please purchase your ticket before your trip to make your journey easier and more comfortable. After searching for a route, you can view the estimated price and continue with ticket booking."
    },
    services: {
        title: "SERVICES",
        text: "We offer route searching, travel time estimation, ticket price calculation, real-time map preview, customer support, and mobile-friendly access so you can plan your journey from anywhere."
    },
    contact: {
        title: "CONTACT US",
        text: "Email: support@busstation.com\nPhone: +389 70 123 456\nOur team is available every day to help you with routes, schedules, tickets, and general travel questions."
    }
};
